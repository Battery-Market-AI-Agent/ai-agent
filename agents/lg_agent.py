"""
T2: LG에너지솔루션 조사 Agent (WebSearch 기반)

# BaseAgent 상속
# Tool: WebSearch
# 확증 편향 방지: 긍정 쿼리 + 부정 쿼리 병렬 검색
#   - 긍정: "LG에너지솔루션 ESS 성장 전략 포트폴리오 다각화 2025 2026"
#   - 부정: "LG에너지솔루션 실적 부진 리스크 가동률 하락 약점 2025 2026"
...
class LGAgent(BaseAgent):
    """T2: LG에너지솔루션 조사 — WebSearch 확증 편향 방지 병렬 검색."""
    ...
    def run(self, state: ReportState) -> ReportState:
        ...
        # 5. state["lg"]에 ResearchResult 형태로 저장
        ...
